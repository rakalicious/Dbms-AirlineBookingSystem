...
insert into login_record values('test_user','test_pass');
...
create table transactions(
   pnr number GENERATED ALWAYS AS IDENTITY(START WITH 12230),
    booking_date TIMESTAMP,
	username varchar2(50),
	flight_id varchar2(10),
	fare number(10,3),
	no_of_seats_booked number(3),
	reservation_status varchar2(15) check (status IN ('CANCELLED','BOOKED'),
...
alter table current_runnning_status
...
select f.flight_id,f.src,f.dest,f.departure,f.arrival,t.status from (select * from flight_schedule where day = 5) f 
left outer join (
	select s.flight_id as flight_id, s.status as Status from current_runnning_status s 
	where dt = to_date('12-12-2012','DD-MM-YYYY')
...
BEGIN
	...
	if lft < reqSeats then
		...
		insert into transactions(booking_date,username,flight_id,fare,no_of_seats_booked,reservation_status,date_of_journey) values (CURRENT_TIMESTAMP,usr,fid,faretaken,reqSeats,'BOOKED',dat);
		commit;
	end if;
...
declare 
begin
ticketbooking('6G-229',to_date('23-07-2017','DD-MM-YYYY'),250,'test',12354);
end;
/
...
insert into aeroplane_detail values ('pid001',100 ,'JetBlue',3.55);
insert into aeroplane_detail values ('pid002',110,'SpiceJet',4.75);
insert into aeroplane_detail values ('pid003',130 ,'JetBlue',6.23;
insert into aeroplane_detail values ('pid004',105 ,'Indigo',8.30);
insert into aeroplane_detail values ('pid005',80 ,'GoAir',4.36);
insert into aeroplane_detail values ('pid006',95 ,'AirIndia',10.56);
insert into aeroplane_detail values ('pid007',110 ,'Vistara',7.56);
insert into aeroplane_detail values ('pid008',110,'SpiceJet',6.23);
insert into aeroplane_detail values ('pid009',130 ,'GoAir',10.00);
insert into aeroplane_detail values ('pid010',120 ,'Vistara',7.89);
insert into aeroplane_detail values ('pid011',110 ,'FlyEmirates',18.56);
insert into aeroplane_detail values ('pid012',100 ,'AirAsia',15.36);
insert into aeroplane_detail values ('pid013',120 ,'Indigo',3.33);
insert into aeroplane_detail values ('pid014',130 ,'AirIndia',12.31);
insert into aeroplane_detail values ('pid015',100 ,'JetBlue',9.56);
insert into aeroplane_detail values ('pid016',100 ,'GoAir',4.87);
insert into aeroplane_detail values ('pid017',150 ,'Vistara',5.45);
insert into aeroplane_detail values ('pid018',140 ,'SpiceJet',6.66);
insert into aeroplane_detail values ('pid019',140 ,'Indigo',7.86);
insert into aeroplane_detail values ('pid020',30 ,'JetBlue',13.86);
...
insert into flight_schedule values ('6E-910',1,'1415','1230','BLR','BOM');    # hyd > blr > bom
insert into flight_schedule values ('6E-911',1,'0805','0730','MAA','BLR');
insert into flight_schedule values ('6E-912',1,'1155','1045','HYD','BLR');  # hyd > blr > bom
...
insert into flight_schedule values ('6F-015',1,'1845','1500','BOM','BLR'); #resolved
...
insert into flight_schedule values ('6E-927',2,'1410','1300','BLR','HYD');   # DEL > BLR >HYD
...
insert into flight_schedule values ('6E-930',2,'1240','1000','DEL','BLR');      #  DEL > BLR > HYD
...
insert into flight_schedule values ('6E-935',3,'1225','1100','PNQ','BLR');  # DEL > PNQ >BLR
insert into flight_schedule values ('6E-936',3,'1005','0800','DEL','PNQ');  # DEL > PNQ > BLR
insert into flight_schedule values ('6E-937',3,'0710','0600','JAI','AMD');
insert into flight_schedule values ('6E-938',3,'1045','0900','BOM','JAI');  # BOM > JAI > DEL
insert into flight_schedule values ('6E-939',3,'1635','1430','HYD','KOL');
insert into flight_schedule values ('6E-940',3,'1745','1500','BOM','KOL');   # ROUND TRIP  BOMKOLAM
insert into flight_schedule values ('6E-941',3,'0945','0700','KOL','BOM');   # ROUND TRIP
insert into flight_schedule values ('6E-942',3,'2135','1900','KOL','AMD');  # BOMKOLAMD
...
insert into flight_schedule values ('6E-945',3,'1230','1130','JAI','DEL');  # BOM > JAI > DEL
...
insert into flight_schedule values ('6E-951',4,'2145','2000','AMD','HYD'); # PNQ > AMD >HYD
insert into flight_schedule values ('6E-952',4,'1820','1700','PNQ','AMD'); # PNQ > AMD > HYD
...
insert into flight_schedule values ('6E-955',4,'1415','1230','BLR','BOM');    # hyd > blr > bom
insert into flight_schedule values ('6E-956',4,'0805','0730','MAA','BLR');
insert into flight_schedule values ('6E-957',4,'1155','1045','HYD','BLR');  # hyd > blr > bom
...
insert into flight_schedule values ('6E-972',5,'1410','1300','BLR','HYD');   # DEL > BLR >HYD
...
insert into flight_schedule values ('6E-975',5,'1240','1000','DEL','BLR');      #  DEL > BLR > HYD
...
insert into flight_schedule values ('6E-978',6,'1750','1500','DEL','MAA');   # ROUND TRIP
insert into flight_schedule values ('6E-979',6,'1510','1300','KOL','DEL');
insert into flight_schedule values ('6E-980',6,'1050','0800','MAA','DEL');   # ROUND TRIP
...
insert into flight_schedule values ('6E-985',6,'1415','1230','BLR','BOM');    # hyd > blr > bom
insert into flight_schedule values ('6E-986',6,'0805','0730','MAA','BLR');
insert into flight_schedule values ('6E-987',6,'1155','1045','HYD','BLR');  # hyd > blr > bom
...
insert into flight_schedule values ('6F-005',7,'1225','1100','PNQ','BLR');  # DEL > PNQ >BLR
insert into flight_schedule values ('6F-006',7,'1005','0800','DEL','PNQ');  # DEL > PNQ > BLR
insert into flight_schedule values ('6F-007',7,'0710','0600','JAI','AMD');
insert into flight_schedule values ('6F-008',7,'1045','0900','BOM','JAI');  # BOM > JAI > DEL
insert into flight_schedule values ('6F-009',7,'0650','0500','MAA','BOM');
insert into flight_schedule values ('6F-010',7,'1745','1500','BOM','KOL');   # ROUND TRIP  BOMKOLAMD #
insert into flight_schedule values ('6F-011',7,'0945','0700','KOL','BOM');   # ROUND TRIP
insert into flight_schedule values ('6F-012',7,'2135','1900','KOL','AMD');  # BOMKOLAMD
...
insert into flight_schedule values ('6F-015',7,'1230','1130','JAI','DEL');  # BOM > JAI > DEL
...
insert into flight_map values ('6F-310','pid051'); #resolved
insert into flight_map values ('6F-311','pid052'); #resolved
...
insert into flight_map values ('6F-117','pid108'); ######error
